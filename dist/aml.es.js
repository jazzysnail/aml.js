...
cloneableTags[errorTag$2] = cloneableTags[funcTag$2] = cloneableTags[weakMapTag$1] = false;
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === undefined || eq(objValue, objectProto$20[key]) && !hasOwnProperty$17.call(object, key)) {
    return srcValue;
  }
  return objValue;
}
 ...
 * @param  {[Array]}
 */
var difference$2 = function (arr) {
  if (isArray$2(arr, 1)) {
    var _arr = cloneDeep(arr);
...
var union$2 = function (arr) {
  if (isArray$2(arr, 1)) {
    var _arr = cloneDeep(arr);
    var _key = this.__proto__.key;
    var _thisArr = cloneDeep(this);
